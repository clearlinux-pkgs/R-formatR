...
Version  : 1.10
Release  : 77
URL      : https://cran.r-project.org/src/contrib/formatR_1.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/formatR_1.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621964293
