...
Version  : 1.9
Release  : 74
URL      : https://cran.r-project.org/src/contrib/formatR_1.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/formatR_1.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618449472
