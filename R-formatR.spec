...
Version  : 1.12
Release  : 88
URL      : https://cran.r-project.org/src/contrib/formatR_1.12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/formatR_1.12.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648827229
