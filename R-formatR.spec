...
Version  : 1.8
Release  : 70
URL      : https://cran.r-project.org/src/contrib/formatR_1.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/formatR_1.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615821323
